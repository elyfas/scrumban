...
export default function App() {
  ...
  const renderMainContent = () => {
    switch (activeSection) {
      ...
      case 'kanban-relatorios':
        return (
          <div className="p-8">
            ...
            <p className="text-gray-600">Selecione um tipo de relatório no menu lateral para começar.</p>
            <div className="mt-6 grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="p-6 border border-gray-200 rounded-lg hover:shadow-md transition-shadow cursor-pointer" 
                ...
                <h3 className="text-lg font-semibold text-gray-900 mb-2">Relatórios Operacionais</h3>
                <p className="text-gray-600">Métricas de performance, velocity, burndown e análises de sprint.</p>
              </div>
              <div className="p-6 border border-gray-200 rounded-lg hover:shadow-md transition-shadow cursor-pointer"
                ...
                <p className="text-gray-600">Custos de projeto, ROI, análise de recursos e orçamentos.</p>
              </div>
            </div>
          </div>
        );
      ...
      case 'kanban-gestao':
        return <ManagementHub onSectionChange={setActiveSection} />;
      ...
      default:
        return (
          <div className="p-8">
            <h1 className="text-2xl font-bold text-gray-900 mb-4">Em Desenvolvimento</h1>
